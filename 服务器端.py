        ...
        for cell in col:
            ...
            if cell.value==user:
                ...
                if rightcode==code:
                    ...
                    data="0002"+str(usercode)+"*"+str(ws['D' + str(cell.row)].value)+"*"+str(ws['E' + str(cell.row)].value)
...
def decryptplus1(receivedata,server_private_key2):
    ...
    try:
       original_message = server_private_key2.decrypt(receivedata,padding.OAEP(mgf=padding.MGF1(algorithm=hashes.SHA256()),algorithm=hashes.SHA256(),label=None))
    except:
        return 'fail'
    else:
     ...
     try:
         ...
         if not (receivedata[0:4].isdigit()):
             ...
             if receivedata=='fail':
                 ...
                 print("一线程关闭4")
                 break
         else:receivedata = receivedata.decode('utf-8')
